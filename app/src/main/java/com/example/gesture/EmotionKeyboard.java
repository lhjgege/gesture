...
public class EmotionKeyboard {
    ...
    private HashMap<String, Integer> mKeyboardViewPading = new HashMap<>();

    // 构造函数私有化，只能通过with方法获取实例
    private EmotionKeyboard() {
        mKeyboardViewPading.put("left", 0);
        mKeyboardViewPading.put("right", 0);
        mKeyboardViewPading.put("top", 0);
        mKeyboardViewPading.put("bottom", 0);
    }
    ...
    public EmotionKeyboard bindKeyboardViewToTop(View keyboard) {
        ...
        mKeyboardViewPading.put("top", mKeyboardViewToTop.getPaddingTop());
        mKeyboardViewPading.put("left", mKeyboardViewToTop.getPaddingLeft());
        mKeyboardViewPading.put("right", mKeyboardViewToTop.getPaddingRight());
        mKeyboardViewPading.put("bottom", mKeyboardViewToTop.getPaddingBottom());
        View rootView;
        ...
        rootView.getViewTreeObserver().addOnGlobalLayoutListener(() -> {
            ...
            if (heightDiff > 0) {
                mKeyboardViewToTop.setPadding(mKeyboardViewPading.get("left"), mKeyboardViewPading.get("top"), mKeyboardViewPading.get("right"), mKeyboardViewPading.get("bottom") + getKeyBoardHeight());
            } else {
                mKeyboardViewToTop.setPadding(mKeyboardViewPading.get("left"), mKeyboardViewPading.get("top"), mKeyboardViewPading.get("right"), mKeyboardViewPading.get("bottom"));
            }
        });
        return this;
    }
