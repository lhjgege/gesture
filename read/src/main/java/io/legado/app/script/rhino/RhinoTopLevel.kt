...
import io.legado.app.script.SimpleScriptContext
    ...
    companion object {
        ...
        fun bindings(
            ...
            if (args.size == 1) {
                ...
                if (arg is io.legado.app.script.rhino.ExternalScriptable) {
                    val ctx = arg.context
        ...
        fun scope(cx: Context, thisObj: Scriptable?, args: Array<Any?>, funObj: Function?): Any {
            if (args.size == 1) {
                ...
                if (arg is Bindings) {
                    ...
                    val res: Scriptable = io.legado.app.script.rhino.ExternalScriptable(ctx)
