...
import io.legado.app.script.AbstractScriptEngine
import io.legado.app.script.Bindings
import io.legado.app.script.Compilable
import io.legado.app.script.CompiledScript
import io.legado.app.script.Invocable
...
import io.legado.app.script.SimpleBindings
...
object RhinoScriptEngine : AbstractScriptEngine(), Invocable, Compilable {
    ...
    override fun getRuntimeScope(context: ScriptContext): Scriptable {
        val newScope: Scriptable =
            io.legado.app.script.rhino.ExternalScriptable(context, indexedProps)
        val cx = Context.enter()
        try {
    ...
    override fun compile(script: Reader): CompiledScript {
        val cx = Context.enter()
        val ret: io.legado.app.script.rhino.RhinoCompiledScript
        try {
            var fileName = this["javax.script.filename"] as? String
            if (fileName == null) {
            ...
            ret = io.legado.app.script.rhino.RhinoCompiledScript(this, scr)
