...
import com.lhj.read.help.coroutine.Coroutine
import com.lhj.read.utils.runOnUI
...
class BackstageWebView(
    ...
    private fun createWebView(): WebView {
        ...
        settings.userAgentString = headerMap?.get(AppConst.UA_NAME) ?: AppConst.userAgent
